    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-else class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-3">
          <!-- Featured Posts -->
          <section
            v-if="featuredPosts.length > 0 && !searchTerm && !selectedCategory"
            class="mb-12"
          >
            <h2 class="text-2xl font-bold text-gray-900 mb-6">精選文章</h2>
                ...
                <BaseCard hoverable clickable class="h-full">
                  <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                      ...
                      <h3
                        class="text-xl font-semibold text-gray-900 group-hover:text-primary-600 transition-colors line-clamp-2"
                      >
                        {{ post.title }}
                      </h3>
                      ...
                      >
                        ...
                        <span class="flex items-center space-x-1">
                          ...
                          <span
                            >{{ estimateReadTime(post.content) }} 分鐘閱讀</span
                          >
                        </span>
                      </div>
                    </div>
          ...
          <section>
            <div class="flex items-center justify-between mb-6">
              <h2 class="text-2xl font-bold text-gray-900">
                {{ searchTerm || selectedCategory ? "搜尋結果" : "最新文章" }}
                <span
            ...
            <div v-if="filteredPosts.length === 0" class="text-center py-16">
              ...
              <h3 class="mt-4 text-lg font-medium text-gray-900">
                {{ searchTerm || selectedCategory ? "找不到文章" : "尚無文章" }}
              </h3>
              ...
              >
                <div class="p-6">
                  <div class="flex flex-col md:flex-row md:space-x-6">
                    ...
                    <div
                      v-if="false"
                      class="md:w-48 mb-4 md:mb-0 flex-shrink-0"
                    >
                      <img
                        src=""
                        :alt="post.title"
                      ...
                      <div class="space-y-3">
                        ...
                        >
                          ...
                          <span class="flex items-center space-x-1">
                            <ClockIcon class="w-4 h-4" />
                            <span
                              >{{ estimateReadTime(post.content) }} 分鐘</span
                            >
                          </span>
                        </div>
                        ...
                        <!-- Title -->
                        <h3
                          class="text-xl font-semibold text-gray-900 hover:text-primary-600 transition-colors line-clamp-2"
                        >
                          {{ post.title }}
                        </h3>
        ...
        <div class="lg:col-span-1 space-y-6">
          ...
          <BaseCard v-if="popularPosts.length > 0" title="熱門文章">
            <div class="space-y-4">
              ...
              >
                <h4
                  class="font-medium text-sm text-gray-900 group-hover:text-primary-600 transition-colors line-clamp-2 mb-1"
                >
                  {{ post.title }}
                </h4>
          ...
          <!-- Categories -->
          <BaseCard v-if="categories.length > 0" title="分類">
            <div class="space-y-2">
              <button
          ...
          <!-- Tags -->
          <BaseCard v-if="popularTags.length > 0" title="熱門標籤">
...
const featuredPosts = computed(() =>
  posts.value.filter((post) => post.slug?.includes("featured")).slice(0, 3),
);
