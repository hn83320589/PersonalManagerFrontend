    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div v-else-if="profile" class="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <BaseCard class="text-center">
            <div class="space-y-6">
              <div>
                ...
                <div
                  v-else
                  class="w-48 h-48 rounded-full mx-auto bg-gray-200 flex items-center justify-center"
                >
              ...
              <div>
                ...
                <p
                  v-if="profile.title"
                  class="text-lg text-primary-600 font-medium"
                >
                  {{ profile.title }}
                </p>
              </div>
        ...
        <div class="lg:col-span-2 space-y-8">
          <!-- Bio Section -->
          <BaseCard v-if="profile.description" title="個人簡介">
          ...
          <!-- Skills Summary -->
          <BaseCard v-if="expertSkills.length > 0" title="核心專長">
          ...
          <!-- Current Position -->
          <BaseCard v-if="currentPosition" title="目前職位">
            <div class="space-y-2">
          ...
          <!-- Latest Education -->
          <BaseCard v-if="latestEducation" title="學歷">
            <div class="space-y-2">
              <h3 class="text-lg font-semibold text-gray-900">
                {{ latestEducation.degree }}
                <span v-if="latestEducation.fieldOfStudy">
                  - {{ latestEducation.fieldOfStudy }}</span
                >
              </h3>
              <p class="text-primary-600 font-medium">
              ...
              <p class="text-gray-600">
                ...
                <span v-if="latestEducation.endYear"
                  >- {{ latestEducation.endYear }}</span
                >
                <span v-else>- 至今</span>
              </p>
            </div>
          ...
          <BaseCard class="bg-primary-50 border-primary-200">
            <div class="text-center space-y-4">
              <h3 class="text-xl font-semibold text-gray-900">一起合作</h3>
              <p class="text-gray-600">
                有合作想法或專案需求嗎？歡迎與我聯繫。
              </p>
              <div class="flex justify-center space-x-4">
                ...
                <router-link to="/portfolio">
                  <BaseButton variant="outline"> 查看作品集 </BaseButton>
                </router-link>
              </div>
            </div>
          </BaseCard>
      ...
      <div v-else class="text-center py-12">
        <p class="text-gray-600">無法載入個人資料。</p>
      </div>
    </section>
  </div>
</template>
